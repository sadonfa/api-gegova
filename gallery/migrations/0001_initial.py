# Generated by Django 5.0.6 on 2024-06-20 05:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_ad', models.DateTimeField(auto_now_add=True, verbose_name='Creado el')),
                ('update_ad', models.DateTimeField(auto_now=True, verbose_name='Actualizado el')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gallery.client', verbose_name='Categoria')),
            ],
        ),
    ]
